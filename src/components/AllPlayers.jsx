...
export default function AllPlayers({ statuses, teams, onSelectPlayer, refreshKey, onRefresh }) {
  ...
  // ⚡ Bolt: Performance Optimization - Memoize filtered and sorted players to prevent expensive recalculations on every render
  ...
  // ⚡ Bolt: Performance Optimization - Memoize player counts to prevent recalculations
