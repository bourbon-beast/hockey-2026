...
export default function AllPlayers({ statuses, teams, onSelectPlayer, refreshKey, onRefresh }) {
  ...
  // ⚡ Bolt: Memoize the filtered and sorted player list to prevent expensive O(N log N) re-evaluations on every render
  ...
  // ⚡ Bolt: Memoize aggregate counts to avoid filtering the entire player list on unrelated state changes
