...
export default function RoundPlanner({ statuses, onSelectPlayer }) {
  ...
  }, [allPlayers, roundData, pickerOpen?.teamId, roundUnavailability, showUnavailableInPicker, currentRound?.sat_date, currentRound?.sun_date, notInRoundFilter, activeChips, pickerTeamFilter, playerTeamMap, searchTerm])
