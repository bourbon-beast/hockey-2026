...
export default function RoundPlanner({ statuses, onSelectPlayer, isAdmin }) {
  ...
  const currentRoundSat = currentRound?.sat_date;
  const currentRoundSun = currentRound?.sun_date;
  ...
  const availablePlayers = useMemo(() => {
    ...
    return allPlayers
        ...
        .filter(p => {
          ...
          const matchDay = teamMatch?.match_date === currentRoundSat ? 'sat'
                         : teamMatch?.match_date === currentRoundSun ? 'sun'
                         : null
    ...
    roundData, pickerTeamId, allPlayers, roundUnavailability,
    showUnavailableInPicker, currentRoundSat, currentRoundSun,
    notInRoundFilter, activeChips, pickerTeamFilter, playerTeamMap, searchTerm
  ])
