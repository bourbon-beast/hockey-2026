...
export default function RoundPlanner({ statuses, onSelectPlayer }) {
  ...
  const duplicateIds = useMemo(() => getters.getDuplicatePlayerIds(), [roundData, getters])
  ...
  }, [allPlayers, roundData, pickerOpen, showUnavailableInPicker, pickerTeamFilter, playerTeamMap, searchTerm, roundUnavailability])
