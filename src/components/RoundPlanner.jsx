...
export default function RoundPlanner({ statuses, onSelectPlayer, isAdmin }) {
  ...
  // Impact: Prevents recreating playerTeamMap object mapping on every render
  const playerTeamMap = useMemo(() => {
    return roundData ? Object.fromEntries(roundData.selections.map(s => [s.player_id, s.team_id])) : {}
  }, [roundData])

  // ⚡ Bolt: Performance Optimization
  // Impact: Prevents expensive re-evaluation and sorting of the large allPlayers array on every render, especially on typing
  const availablePlayers = useMemo(() => {
    ...
    showUnavailableInPicker, currentRound?.sat_date, currentRound?.sun_date,
