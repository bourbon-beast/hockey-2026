...
export default function RoundPlanner({ statuses, onSelectPlayer, isAdmin }) {
  ...
  // ⚡ Bolt: Performance Optimization - Memoize available players to prevent unnecessary filtering/sorting on every render
  const availablePlayers = useMemo(() => {
    ...
    allPlayers, roundData?.selections, roundData?.matches, pickerOpen?.teamId,
    roundUnavailability, showUnavailableInPicker, currentRound?.sat_date, currentRound?.sun_date,
